...
?>
    ...
    <head>
        ...
        <title>Selling History | Online Fashion Store</title>
    ...
    <body style="background-color: #F9F9F9;">
        ...
        <section id="content">
            ...
            <nav>
                ...
                <a href="#" class="nav-link">Selling History</a>

                <form>
                    <div class="form-input">
                        <input type="search" placeholder="Order ID..." id="selling_search">
                        <button type="submit" class="search-btn">
                            <i class='bx bx-search' onclick="sellHistorySearch();"></i>
                        </button>
                    </div>
                </form>
                    ...
                    ?>
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $selected_data["order_qty"]; ?></td>
                                <td>
